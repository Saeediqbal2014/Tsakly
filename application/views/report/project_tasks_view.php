...
$emps = $this->bm->get_empss_name_by_id($projectDetails[0]["user_id"], $proj_id);
...
<div class="pr-4 pl-4">
    <div class="container">
        <div class="row pt-1 pb-4">
            <div class="col-lg-6">
                <span class="Page_Title"><?= $project[0]->project_name; ?></span>
            </div>
            <div class="col-lg-6">
                <input type="button" onclick="printDiv('printableArea')" class="btn user_invait_btn btn-sm float-right ml-1" value="Print">
                <a href="<?= base_url('Reports/project_reports'); ?>" class="btn user_invait_btn btn-sm float-right ml-1">Back</a>
            </div>
        </div>
                    ...
                    <div class="col-lg-12 p-4 card">
                        ...
                        <div class="box-header" style="margin-top: 2px; height: 40px">
                            ...
                            <h3 style="color:green; text-align: center;">
                                <span style=" font-size: 30px;font-style: inherit; text-transform: uppercase;"> <?php echo "Project Report " ?> </span>
                                <br>
                                ...
                                <div class="box-body pad table-responsive">
                                    <table class='table table-bordered text-center' id="Order_EntriesTable">
                                        <tr style="background-color:#ECF9FF;" id="headingRow">
                                            ...
                                            <!-- <th style="padding:5px; text-align:left;">Advance</th> -->
                                            <th style="padding:5px; text-align:left;">Budget</th>
                                        ...
                                        <tr class="txtMult">
                                            ...
                                            <td style="padding:5px;  text-align:left;">
                                                <?php echo $projectDetails[0]["project_name"] ?>
                                            </td>
                                            <td style="padding:5px;  text-align:left;">
                                            ...
                                            <td style="padding:5px;  text-align:left;">
                                                <?php echo $projectDetails[0]["project_budget"] ?>
                                            </td>
                                            <td style="padding:5px;  text-align:left;">
                                                <?php echo $projectDetails[0]["start_date"] ?>
                                            </td>

                                            <td style="padding:5px;  text-align:left;">
                                                <?php echo $projectDetails[0]["end_date"] ?>
                                            </td>

                                            <td style="padding:5px;  text-align:left;">
                                                <?php echo $projectDetails[0]["notify_days"] ?>
                                            </td>
                                                ...
                                                ?>
                                                        <div class="row pt-3 pl-5 pr-5">
                                                            <div class="col-lg-6" style="border-bottom: 1px solid grey;">
                                                                <span style="margin-left:-14px"><?= $st->subtask_title ?></span>
                                                            </div>
                                                            <div class="col-lg-6" style="border-bottom: 1px solid grey;">
                                                                <div class="float-right">
                                                                    <span style="margin-right:-14px">Sub Task Amount : <?= $st->subtask_milestone  ?></span>
