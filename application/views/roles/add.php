          ...
          <div class="row">
            <div class="col-lg-10 m-auto">
              <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" name="role_name" required data-parsley-pattern="^[a-z A-Z]+$" data-parsley-trigger="keyup" data-parsley-required-message="Type only Characters.">
              ...
              <table class="table">
                <tr>
                  ...
                  <td>
                    ...
                    <div class="chn rdd">
                      <div class="deal off" data="gr1" data-dependent="gr4,gr3,sgr2,tr2" data-msg="Users can see the Groups Permission is required">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="chn rdd">
                      <div class="deal off" data="gr3" data-on="gr1">
                        <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                      </div>
                    </div>
                    <div class="ranking">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="chn rdd">
                      <div class="deal off" data="gr4" data-on="gr1">
                        <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                      </div>
                    </div>
                    <div class="ranking">
            ...
            <table class="table">
              <tr>
                ...
                <td>
                  ...
                  <div class="chn rdd">
                    <div class="deal off" data="sgr1" data-dependent="sgr4,sgr3,tr2" data-msg="Users can see the Sub Groups Permission is required">
                      <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                    </div>
                  </div>
                  <div class="ranking">
              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="chn rdd">
                    <div class="deal off" data="sgr2" data-on="gr1">
                      <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                    </div>
                  </div>
                  <div class="ranking">
              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="chn rdd">
                    <div class="deal off" data="sgr3" data-on="sgr1">
                      <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                    </div>
                  </div>
                  <div class="ranking">
              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="chn rdd">
                    <div class="deal off" data="sgr4" data-on="sgr1">
                      <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                    </div>
                  </div>
                  <div class="ranking">
          ...
          <table class="table">
            <tr>
              ...
              <td>
                ...
                <div class="chn rdd">
                  <div class="deal off" data="tr1" data-dependent="tr4,tr3" data-msg="Users can see the Transaction Permission is required">
                    <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                  </div>
                </div>
                <div class="ranking">
            ...
            <tr>
              ...
              <td>
                ...
                <div class="chn rdd">
                  <div class="deal off" data="tr2" data-on="gr1,sgr1">
                    <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                  </div>
                </div>
                <div class="ranking">
            ...
            <tr>
              ...
              <td>
                ...
                <div class="chn rdd">
                  <div class="deal off" data="tr3" data-on="tr1">
                    <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                  </div>
                </div>
                <div class="ranking">
            ...
            <tr>
              ...
              <td>
                ...
                <div class="chn rdd">
                  <div class="deal off" data="tr4" data-on="tr1">
                    <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                  </div>
                </div>
                <div class="ranking">
        ...
        <table class="table">
          <tr>
            ...
            <td>
              ...
              <div class="chn rdd">
                <div class="deal off" data="c1" data-dependent="c4,c3" data-msg="Users can see the categories Permission is required">
                  <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                </div>
              </div>
              <div class="ranking">
          ...
          <tr>
            ...
            <td>
              ...
              <div class="chn rdd">
                <div class="deal off" data="c3" data-on="c1">
                  <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                </div>
              </div>
              <div class="ranking">
          ...
          <tr>
            ...
            <td>
              ...
              <div class="chn rdd">
                <div class="deal off" data="c4" data-on="c1">
                  <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
                </div>
              </div>
              <div class="ranking">
      ...
      <table class="table">
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="u1" data-on="" data-dependent="u3,u4,u5,u6,u7" data-msg="Users can see the Users Permission is required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="u2" data-on="" data-dependent="c1" data-msg="Users can create a new user Permission is required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="u6" data-on="u1">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="u3" data-on="u1" data-dependent="" data-msg="yeh o chaye">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="u4" data-on="u1" data-msg="yeh o chaye">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="u5" data-on="u1">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="u7" data-on="u1">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
      ...
      <table class="table">
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off p_see" data="p1" data-dependent="p3,p4,p6,p7,p8,p9,t1,t2,n1" data-msg="Users can see the projects Permission is required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="p3" data-on="p1||p5">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="p4" data-on="p1||p5">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off p_see" data="p5">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="p6" data-on="p1" data-dependent="t2" data-msg="Users can change the projects leader Permission is required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="p7" data-on="p1||p5">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="p8" data-on="p1||p5">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="p9" data-on="p1||p5">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
      ...
      <table class="table">
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off t_see" data="t1" data-on="p1||p5" data-dependent="t3,t4,t7,st1,st2,st5,n2" data-msg="Users can see the tasks Permission required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="t2" data-on="p6,p1||p5" data-msg="Users can create a new tasks Permission is required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="t3" data-on="t1" data-dependent="t6" data-msg="Users can edit a tasks Permission is required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="t4" data-on="t1">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr class="">
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off t_see" data="t5" data-on="p5||p1" data-dependent="t3,t4,st1,st2,st5">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="t7" data-on="t1" data-dependent="t6" data-msg="Users can see a the budget of task Permission is required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="t6" data-on="t3,t7">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
      ...
      <table class="table">
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off s_see" data="st1" data-on="t1" data-dependent="st3,st4,st7,n3" data-msg="Users can see the subtasks Permission required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="st2" data-on="t1">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="st3" data-on="st1" data-dependent="st6" data-msg="Users can edit a subtasks Permission is required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="st4" data-on="st1">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal s_see off" data="st5" data-on="t1" data-dependent="st3,st4,st7">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="st7" data-on="st1" data-dependent="st6" data-msg="Users can see the budget of subtasks Permission is required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="st6" data-on="st3,st7">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
      ...
      <table class="table">
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="r1" data-dependent="r4,r5" data-msg="Users can see all users reports Permission required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="r4" data-on="r1">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="r5" data-on="r1">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
      ...
      <table class="table">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="l3" data-dependent="l5,l6" data-msg="Users can the requests of leaves Permission required">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="l5" data-on="l3">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="l6" data-on="l3">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
      ...
      <table class="table">
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="n1" data-on="p1||p5">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="chn rdd">
              <div class="deal off" data="n2" data-on="t1">
                <i class="fa fa-circle" aria-hidden="true" style="font-size:22px;margin-top:1px "></i>
              </div>
            </div>
            <div class="ranking">
