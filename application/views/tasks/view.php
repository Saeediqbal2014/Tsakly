                        ...
                        <div class="row mt-5">
                          ...
                          <div class="col-lg-9 mt-4">
                              <div class="row">
                                  ...
                                  <div class="col-lg-12">
                                      <input type="hidden" name="id" value="<?= $task->project_task_id ?>">
...
<script type="text/javascript">
    ...
    $("form#commentForm").submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url('projects/task_comments_insert') ?>',
            data: formData,
            processData: false,
            contentType: false,
            success: function() {
    ...
    function comments() {
    var id = '<?= $task->project_task_id ?>';
    $.ajax({
      url: '<?= base_url('projects/task_comments') ?>',
      data: {
        id: id
      },
      method: 'Post',
