            ...
            <div class="pr-4 pl-4">
                <div class="container">
                    <div class="row pt-1 pb-1">
                        <div class="col-lg-6">
                            <a class="" style=""></a><span class="Page_Title">Invite User</span>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <!-- secod_Row_Start -->
                    <form action="<?=base_url('categories/add')?>" method="post" id="validate_form"> 
                    <div class="row pt-5">
                      ...
                      <div class="col-lg-10 m-auto">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-sm" name="category" required data-parsley-pattern="^[a-z A-Z]+$" data-parsley-trigger="keyup" data-parsley-required-message="Type only Characters." >
