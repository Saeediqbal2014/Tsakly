...
<div class="pr-4 pl-4">
  <div class="container">
    ...
    <!-- secod_Row_Start -->
    <form action="<?= base_url('quotation/add') ?>" method="post" id="validate_form">
      <div class="row pt-3">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="form-group">
                ...
                <input type="hidden" class='slry'/>
                <select name="users[]" multiple="multiple" class="js-example-basic-multiple addSalary" required data-parsley-required-message="You must select at least one option.">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control prct" name="prct" placeholder="Enter Percentage" required data-parsley-required-message="Type only Characters.">
                <span><?= form_error('name') ?></span>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control t_amnt" placeholder="Amount" name="amnt" required readonly />
                    <input type="hidden" class="salary_amnt" name="salary_amnt" value="0">
